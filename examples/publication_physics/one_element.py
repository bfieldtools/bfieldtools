"""
One-element field and potentials
========================================
...
def plot_element():
    ...
    s2.contour.number_of_contours = 7
...
s3.module_manager.scalar_lut_manager.data_range = np.array(
    [-5.38293066e-07, 5.38290000e-07]
)
s3.module_manager.scalar_lut_manager.number_of_colors = 31
s3.actor.mapper.scalar_range = np.array([-6e-07, 6e-07])
s3.actor.mapper.interpolate_scalars_before_mapping = True
