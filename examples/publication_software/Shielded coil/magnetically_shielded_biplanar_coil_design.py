...
if PLOT:
    ...
    if SAVE_FIGURES:
        mlab.savefig('/l/bfieldtools/examples/publication_software/Shielded coil/shielded_biplanar_geometry.png', figure=f, magnification=4)
        mlab.close()
...
if PLOT:
    ...
    if SAVE_FIGURES:
        mlab.savefig('/l/bfieldtools/examples/publication_software/Shielded coil/shielded_biplanar_ignored.png', figure=f, magnification=4)
        mlab.close()
#################################################################
...
if PLOT:
    ...
    f.scene.camera.zoom(0.95)
    if SAVE_FIGURES:
        mlab.savefig('/l/bfieldtools/examples/publication_software/Shielded coil/shielded_biplanar_prospective.png', figure=f, magnification=4)
        mlab.close()
...
if PLOT:
    ...
    if SAVE_FIGURES:
        plt.savefig('/l/bfieldtools/examples/publication_software/Shielded coil/shielding_effect.pdf')
