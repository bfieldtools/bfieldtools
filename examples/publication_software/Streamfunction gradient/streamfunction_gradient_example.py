...
c = Conductor(mesh_file=pkg_resources.resource_filename('bfieldtools', 'example_meshes/curved_surf_w_hole.stl'), process=True, basis_name='suh', N_suh=10, fix_normals=True)
...
mlab.quiver3d(*c.mesh.triangles_center.T, *j, mode='arrow', colormap='Greens', scalars=Len)
...
module_manager2.scalar_lut_manager.scalar_bar_representation.maximum_size = np.array([100000, 100000])
module_manager2.scalar_lut_manager.scalar_bar_representation.minimum_size = np.array([1, 1])
module_manager2.scalar_lut_manager.scalar_bar_representation.position = np.array([0.82, 0.1 ])
module_manager2.scalar_lut_manager.scalar_bar_representation.position2 = np.array([0.17, 0.8 ])
...
scene.scene.camera.position = [-0.3696892487983681, 0.2840788710848503, 3.701830880912346]
scene.scene.camera.focal_point = [-0.3696892487983681, 0.2840788710848503, 0.8575533408480627]
...
mlab.savefig('/l/bfieldtools/examples/publication_software/streamfunction_gradient.png', figure=f, magnification=4)
