...
c = Conductor(
    mesh_file="/l/bfieldtools/examples/publication_software/Surface harmonics/arbitrary_surface2.stl",
    process=True,
    basis_name="suh",
    N_suh=15,
    fix_normals=True,
...
c.suh_basis.plot(
    Nfuncs=c.basis.shape[1], dist=0.1, colormap="RdBu", figure=f, ncolors=256
)
...
mlab.savefig(
    "/l/bfieldtools/examples/publication_software/Surface harmonics/surface_harmonics.png",
    figure=f,
    magnification=4,
)
...
mlab.savefig(
    "/l/bfieldtools/examples/publication_software/Surface harmonics/suhmesh.png",
    figure=f,
    magnification=4,
)
