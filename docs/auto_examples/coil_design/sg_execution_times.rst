...
Computation times
=================
**02:06.147** total execution time for **auto_examples_coil_design** files:

- **02:06.147**: :ref:`sphx_glr_auto_examples_coil_design_biplanar_coil_design.py` (``biplanar_coil_design.py``)
